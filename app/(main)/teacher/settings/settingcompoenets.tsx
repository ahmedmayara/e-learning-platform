...
function Settingcomponenets({ user }: Props) {
  ...
  const handeleditprofile = async () => {
    ...
    await axios.put(
      "http://localhost:8080/api/auth/user/update/teacher/" + user.id,
      user2,
    );
    router.refresh();
  };
      ...
      <Card>
        ...
        <CardContent>
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-2">
              <Label className="text-sm font-medium">Numero telephone</Label>
              <Input
                type="text"
                value={phone}
                onChange={(e) => {
...
export default Settingcomponenets;
